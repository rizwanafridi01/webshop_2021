        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    <h6 class="mb-0 text-uppercase">Edit Region</h6>
                    <hr/>
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Edit Region</h5>
                            </div>
                            <hr>
                            ...
                            <form method="POST" action="{{ route("admin.regions.update", [$region->id]) }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="city_id" class="form-select mb-3" aria-label="Default select example">
                                        <option selected="" readonly="" disabled>Select City</option>
