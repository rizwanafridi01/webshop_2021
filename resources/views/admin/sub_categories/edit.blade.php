            ...
            <div class="col-xl-12 mx-auto">
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <form  class="row g-3" method="POST" action="{{ route("admin.sub_categories.update", $sub_category->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $sub_category->name) }}" placeholder="Enter Sub Category Name" required>
                                @if($errors->has('name'))
