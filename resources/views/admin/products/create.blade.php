                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        ...
                        <div class="card-body">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">New Product</h5>
                            </div>
                            <hr>
                               ...
                               <div class="row">
                                   <div class="col-md-6 py-2">
                                       ...
                                       <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', '') }}" placeholder="Enter Product Name" required>
                                       @if($errors->has('name'))
...
{{--                                    <input name="subCategory_id" id="subCategory_id" class="form-control subCategory_id slct" list="datalistOptions" placeholder="Sub Category">--}}
                                ...
                                <div class="col-md-3 py-2">
                                    ...
                                    <input class="form-control amount {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="text" name="amount" id="amount" value="{{ old('name', '') }}" placeholder="0.00" required>
                                ...
                                <div class="col-md-3 py-2">
                                    ...
                                    <input class="form-control discount {{ $errors->has('discount') ? 'is-invalid' : '' }}" type="text" name="discount" id="discount" value="{{ old('discount', '') }}" placeholder="0.00">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-group">
                                                            <input name="classificationName[]" id="classificationName" type="text" class="form-control classificationName slct" placeholder="Classification Name"  required>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">
                                                            <input name="classificationDesc[]" id="classificationDesc" type="text" class="form-control classificationDesc slct" placeholder="classification Description" required>
                                                        </div>
                                                    </td>
                                                    <td><input class=" btn btn-success addRow1" id="addRow1" type="button" value="+" /></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table color-bordered-table success-bordered-table ">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="form-group">
                                                            <input name="galleryImages[]" id="galleryImages" type="file" class="form-control galleryImages slct" placeholder="galleryImages" required>
                                                        </div>
                                                    </td>
                            ...
                            <div class="card-body ">
                                <div class="row">
                                    <div class="col-md-12 my-4">
                                        ...
                                        <hr>
                                        <textarea name="excerpt" id="excerpt" style="width: 100%; height: 100px" placeholder="Excerpt" class=""></textarea>
                                    </div>
                                    <div class="col-md-12 my-4">
                                        <h6 class="mb-0 text-primary">Shipping Instruction</h6>
                                        <hr>
                                        <textarea name="shippingInstruction" id="shippingInstruction" style="width: 100%; height: 100px" placeholder="shipping Instruction" class="" ></textarea>
                                    </div>

                                    <div class="col-md-12">
                                        <h6 class="mb-0 text-primary">Description</h6>
                                        <hr>
                                        <textarea name="description" id="description" style="width: 100%; height: 100px" placeholder="Description" class="ckeditor"></textarea>
                                    </div>

                                    <div class="col-md-12 my-4">
                                        <h6 class="mb-0 text-primary">Uses</h6>
                                        <hr>
                                        <textarea name="uses" id="uses" style="width: 100%; height: 100px" placeholder="Uses" class="ckeditor"></textarea>
                                    </div>
                                </div>
                            </div>
        ...
        $(document).ready(function (){
            ...
            $(document).on("click",'.addRow', function () {
                ...
                if (validateRow(currentRow)) {
                    ...
                    var html = '';
                    html += '<tr>';
                    html += '<td><input name="galleryImages[]" id="galleryImages" class="form-control galleryImages slct" type="file" placeholder="galleryImages"></td>';
